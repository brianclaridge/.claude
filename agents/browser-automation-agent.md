...
- Screenshots: `/workspace/.data/playwright/screencaps/`
- Videos: `/workspace/.data/playwright/videos/`
- PDFs: `/workspace/.data/playwright/pdfs/`
- Data: `/workspace/.data/playwright/data/`
...
Output: /workspace/.data/playwright/screencaps/example-com-{timestamp}.png
```
...
Output: /workspace/.data/playwright/videos/example-{timestamp}.webm
```
...
Output: /workspace/.data/playwright/data/prices-{timestamp}.json
```
