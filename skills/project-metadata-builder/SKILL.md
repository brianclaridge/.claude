...
Build comprehensive project metadata and maintain a global registry at `~/.claude/projects.yml`.
...
Updates `~/.claude/projects.yml` with:
...
project_metadata:
  ...
  projects_file: ~/.claude/projects.yml
  log_level: INFO
```
